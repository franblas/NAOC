...
#TODO: fix issues when dealing with a lot of mobs to create at first time
# It works with small regions (like 27) or by cutting the mobs list and only keeping 100 mobs
# Idea: spawn a gevent in order to compute player_init_request_handler ??
# gevent.spawn([
